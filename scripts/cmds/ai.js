  ...
  onStart: async function({ api, event, args }) {
    ...
    try {
      ...
      if (!np) {
        ...
        return api.sendMessage('💬 𝗦𝗮𝗹𝘂𝘁 💐 𝗤𝘂𝗲 𝗽𝘂𝗶𝘀-𝗷𝗲 𝗳𝗮𝗶𝗿𝗲 𝗽𝗼𝘂𝗿 𝘁𝗼𝗶? 👋', event.threadID, event.messageID);
      ...
      gpt({
        ...
        messages: [
...

          {
            ...
            content: `💬 𝙃𝙞 𝙄'𝙢 𝗟𝗶𝘇𝗮, 𝙫𝙞𝙧𝙩𝙪𝙖𝙡 𝙖𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩. 𝙒𝙝𝙖𝙩 𝙘𝙖𝙣 𝙞 𝙙𝙤 𝙛𝙤𝙧 𝙮𝙤𝙪 𝗱𝗲𝗮𝗿 💐?`
